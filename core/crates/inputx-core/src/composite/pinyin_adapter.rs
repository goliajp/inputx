...
// ready.
pub const PINYIN_DISABLE_COMPOSE: bool = true;
pub const PINYIN_DISABLE_ASSOCIATION: bool = true;
pub const PINYIN_DISABLE_FUZZY: bool = true;
pub const PINYIN_DISABLE_PREDICTION: bool = true;
