...
mod tests {
    ...
    /// reachable in Japanese at its reading.
    #[test]
    ...
    /// words (guards the akashi→明石 case in phase_g). Pins reachability of
    ...
    /// filter rows; 691 false positives recalled. Representatives pinned:
    ...
    fn no_traditional_in_top10_for_common_wubi() {
        let cases: &[(&str, &[&str])] = &[
            ...
            // (90 dup deletes + 68 trad→simp rewrites). Representative
